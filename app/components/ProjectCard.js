...
const cardInner = (title, description, tags, updatedAt, contentVisible, contentPresent, titleVisible) => {
  ...
  if (onClick) {
    return (
      <button onClick={onClick} className="group block h-full w-full text-left">
        {cardInner(title, description, tags, updatedAt, contentVisible, contentPresent, titleVisible)}
      </button>
    );
  }
